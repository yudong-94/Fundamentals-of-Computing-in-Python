...
# conditional imports
if DESKTOP:
    import project3_solution as alg_project3_solution      # desktop project solution
    import clusters_matplotlib_provided as alg_clusters_matplotlib
else:
...
def load_data_table(data_url):
    ...
    ###local file
    data_list = ["3108", "896", "290", "111"]
    for table in data_list:
        if table in data_url:
            data_file = open("unifiedCancerData_"+table+".csv")
            break
    data = data_file.read()
